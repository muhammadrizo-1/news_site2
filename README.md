thats a project made by me, and the virtual environment may not be same as yours and it may give errors, for preventing that you should delete the directory named "venv".
